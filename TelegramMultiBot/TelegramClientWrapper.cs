...
namespace TelegramMultiBot
{
    public class TelegramClientWrapper
    {
        ...
        public async Task<bool> AnswerInlineQueryAsync(string inlineQueryId)
        {
            var request = new AnswerInlineQueryRequest() { InlineQueryId = inlineQueryId, Results = Array.Empty<InlineQueryResult>() };
