...
public abstract class TelegramCallbackData<T> where T : struct
{
    ...
    protected TelegramCallbackData()
    {
    ...
    public TelegramCallbackData(string command, T type, string? id, object?[] parameters)
    {
        Command = command;
        JobType = type;
        Id = id;
    ...
    public static implicit operator string(TelegramCallbackData<T> data)
    {
