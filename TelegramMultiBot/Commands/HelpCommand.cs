...
⏰ *Моніторинг графиків світла в м\.Київ*
`/monitor add\-dtek\-kem` \- Додати задачу моніторінгу до поточного чату\. 
`/monitor del\-dtek\-kem` \- Видалити задачу моніторінгу з поточного чату\. 
...
`/monitor` \- отримати актуальний графік\.
