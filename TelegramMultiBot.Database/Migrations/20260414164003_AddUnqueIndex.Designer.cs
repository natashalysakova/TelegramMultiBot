...
namespace TelegramMultiBot.Database.Migrations
{
    ...
    [Migration("20260414164003_AddUnqueIndex")]
    partial class AddUnqueIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TelegramMultiBot.Database.Models.ElectricityGroup", b =>
                {
                    ...
                    b.HasIndex("LocationRegion", "GroupCode")
                        .IsUnique();
            ...
            modelBuilder.Entity("TelegramMultiBot.Database.Models.RegionConfigSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("RegionConfigSnapshots");
                });
