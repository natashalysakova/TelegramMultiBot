...
using Bober.Worker.ImageGeneration.Automatic1111.Api;
...
namespace Bober.Worker.ImageGeneration.Automatic1111
{
    class Automatic1111 : IDiffusor
    {
        ...
        public Automatic1111(IConfiguration configuration, ILogger<Automatic1111> logger, ImageDatabaseService databaseService)
        {
            ...
            })
            {
                ...
                for (int i = 0; i < batch_count; i++)
                {
                    ...
                    if (taskResult.StatusCode == System.Net.HttpStatusCode.OK)
                    {
                        ...
                        if (job.Type == ImagineCommands.Upscale)
                        {
